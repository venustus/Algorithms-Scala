...
class TwoSatSpec extends FlatSpec with Matchers {
    "2-SAT instance 1" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat1.txt").getLines.toList.tail
    ...
    "2-SAT instance 2" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat2.txt").getLines.toList.tail
    ...
    "2-SAT instance 3" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat3.txt").getLines.toList.tail
    ...
    "2-SAT instance 4" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat4.txt").getLines.toList.tail
    ...
    "2-SAT instance 5" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat5.txt").getLines.toList.tail
    ...
    "2-SAT instance 6" should "recognize feasibility correctly" in {
        val lines = scala.io.Source.fromURL("file:///Users/venkat/Documents/Coursera/Algorithms-II/src/test/resources/org/venustus/algorithms/npc/2sat6.txt").getLines.toList.tail
